...
<article class="relative flex h-full min-h-0 flex-1 overflow-hidden">
	<div class="hidden max-[760px]:sticky max-[760px]:top-0 max-[760px]:z-[5] max-[760px]:ml-[9px] max-[760px]:flex max-[760px]:min-h-[60px] max-[760px]:w-[calc(100%_-_18px)] max-[760px]:justify-start max-[760px]:gap-[8px] max-[760px]:bg-[var(--bg)] max-[760px]:py-[14px] max-[760px]:pb-[8px]">
		<button
			type="button"
	...
	>
		<div class="min-w-0 px-[18px] pt-[18px] pb-[56px] text-[16px] max-[760px]:px-[10px] max-[760px]:pt-[14px] max-[760px]:pb-[42px] max-[760px]:text-[clamp(16px,4vw,18px)]">
			<header class="mx-auto w-full max-w-[86ch]">
				<h1
					id="post-top"
					data-heading-id="post-top"
					class="mb-[10px] text-[32px] font-bold leading-[1.15] text-[var(--yellow)] max-[760px]:text-[clamp(24px,7vw,30px)]"
				>
					{post.title}
				</h1>
				{#if post.description}
					<p class="my-[10px] mb-[12px] max-w-[80ch] text-justify text-[var(--tx-2)] [text-justify:inter-word] max-[760px]:max-w-none max-[760px]:text-left">
						{post.description}
					</p>
				{/if}
				<div class="grid gap-[4px] mb-[18px] text-[16px] text-[var(--tx-2)] max-[760px]:grid-cols-1 max-[760px]:gap-[2px]">
					<div class="grid grid-cols-[8ch_minmax(0,1fr)] items-start gap-[10px] max-[760px]:grid-cols-1 max-[760px]:gap-[2px]">
						<span class="text-[var(--yellow)] font-bold">date</span>
						<strong class="flex min-w-0 flex-wrap gap-[6px] font-normal [overflow-wrap:anywhere]">
							{formatPostDate(post.date)}
						</strong>
					</div>
					<div class="grid grid-cols-[8ch_minmax(0,1fr)] items-start gap-[10px] max-[760px]:grid-cols-1 max-[760px]:gap-[2px]">
						<span class="text-[var(--yellow)] font-bold">tags</span>
						<strong class="flex min-w-0 flex-wrap gap-[6px] font-normal [overflow-wrap:anywhere]">
